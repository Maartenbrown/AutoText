...
public class AutoReplyDBHelper extends SQLiteOpenHelper {
    ...
    private static final String CreateT2 = "CREATE TABLE "+T2Name+" ("+T2Key+" INTEGER PRIMARY KEY, "
            +T2C1+ " VARCHAR(50), FOREIGN KEY ("+T2C2+") REFERENCES "+T1Name+"("+T1Key+"));";
    ...
    private static final String CreateT3 ="CREATE TABLE "+T3Name+" ("+T3Key+" INTEGER PRIMARY KEY, "+
            T3C1+" TEXT DEFAULT CURRENT_TIMESTAMP, "+
            T3C2+" VARCHAR, FOREIGN KEY ("+T3C3+") REFERENCES "+T1Name+"("+T1Key+"), "+
            "FOREIGN KEY ("+T3C4+") REFERENCES "+T2Name+"("+T2Key+"));";
    ...
    private static final String CreateT4 ="CREATE TABLE "+T4Name+" ("+T4Key+" INTEGER PRIMARY KEY, "+
            T4C1+" TEXT , "+
            T4C2+" VARCHAR, FOREIGN KEY ("+T4C3+") REFERENCES "+T1Name+"("+T1Key+"), "+
            "FOREIGN KEY ("+T4C4+") REFERENCES "+T2Name+"("+T2Key+"));";
    ...
    private static final String CreateT5 = "CREATE TABLE "+T5Name+" ("+T5Key+" INTEGER PRIMARY KEY, "+
            "FOREIGN KEY ("+T5C1+") REFERENCES "+T2Name+"("+T2Key+"));";
    ...
    private static final String CreateT8 ="CREATE TABLE "+T8Name+" ("+T8Key+" INTEGER PRIMARY KEY, "+
            "FOREIGN KEY ("+T8C1+") REFERENCES "+T6Name+" ("+T6Key+"), "+
            "FOREIGN KEY ("+T8C2+") REFERENCES "+T7Name+" ("+T7Key+"));";
    ...
    private static final String CreateT9="CREATE TABLE "+T9Name +" ("+T9Key+" INTEGER PRIMARY KEY, "+
            ...
            T9C6+" INTEGER, "+" FOREIGN KEY ("+T9C7+") REFERENCES "+T8Name+" ("+T8Key+")"+
            "FOREIGN KEY ("+T9C8+") REFERENCE "+T1Name+" ("+T1Key+"));";
    ...
    private static final String CreateT10 ="CREATE TABLE "+T10Name+" ( FOREIGN KEY ("+T10C1+") REFERENCES "+T9Name+" ("+T9Key+") , "+
            "FOREIGN KEY ("+T10C2+") REFERENCES "+T5Name+" ("+T5Key+"), "+
